...
namespace Gurux.Net
{
    ...
    Thread m_ReceiverThread;
        ...
        public GXNet Attach(object info)
        {
            ...
            if (info is string)
            {
                ...
                {
                    throw new ArgumentException(Electroplus_Media_Converter.Properties.Resources.AttachByStringCanBeUsedOnlyWithTCPIPConnection);
                }
            }
            else if (info is GXNetReceiveEventArgs)
            {
                ...
                if (pos == -1)
                {
                    throw new ArgumentException(Electroplus_Media_Converter.Properties.Resources.InvalidSenderInfo);
                }
            ...
            if (net.socket == null)
            {
                throw new ArgumentException(Electroplus_Media_Converter.Properties.Resources.UnknownAddress);
            }
            return net;
        }
        ...
        private void SendInternal(object data, object receiver)
        {
            ...
            {
                throw new Exception(Electroplus_Media_Converter.Properties.Resources.InvalidConnection);
            }
            string target = null;
            ...
            else
            {
                ...
                else if (this.Protocol == NetworkType.Tcp)
                {
                    ...
                    if (client == null)
                    {
                        if (parent == null)
                        {
                            throw new Exception(Electroplus_Media_Converter.Properties.Resources.InvalidClient);
                        }
        ...
        public void Open()
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException(Electroplus_Media_Converter.Properties.Resources.ProtocolTxt);
                }
                if (this.isServer)
                {
                    StartServer();
        ...
        private void StartServer()
        {
            ...
            if (Trace >= TraceLevel.Info && m_OnTrace != null)
            {
                string str = string.Format("{0} {1} {2} {3} {4}",
                                           Electroplus_Media_Converter.Properties.Resources.ServerSettings,
                                           Electroplus_Media_Converter.Properties.Resources.ProtocolTxt,
                                           communicationProtocol,
                                           Electroplus_Media_Converter.Properties.Resources.PortTxt,
                                           port);
        ...
        ep = new DnsEndPoint(HostName, Port);
            ...
            if (Trace >= TraceLevel.Info && m_OnTrace != null)
            {
                string str = string.Format("{0} {1} {2} {3} {4} {5} {6}",
                                           Electroplus_Media_Converter.Properties.Resources.ClientSettings,
                                           Electroplus_Media_Converter.Properties.Resources.ProtocolTxt,
                                           communicationProtocol.ToString(),
                                           Electroplus_Media_Converter.Properties.Resources.HostNameTxt,
                                           hostAddress,
                                           Electroplus_Media_Converter.Properties.Resources.PortTxt,
                                           port.ToString());
                m_OnTrace(this, new TraceEventArgs(TraceTypes.Info, str, null));
        ...
        public override string ToString()
        {
            ...
            if (isServer)
            {
                sb.Append(Electroplus_Media_Converter.Properties.Resources.ServerTxt);
            }
            else
            {
                sb.Append(Electroplus_Media_Converter.Properties.Resources.ClientTxt);
            }
            ...
            {
                sb.Append(' ');
                sb.Append(Electroplus_Media_Converter.Properties.Resources.IPv6Txt);
            }
            return sb.ToString();
        }
    ...
    event ClientDisconnectedEventHandler IGXMedia.OnClientDisconnected
    {
        ...
        {
            return new Gurux.Shared.PropertiesForm(PropertiesForm, Electroplus_Media_Converter.Properties.Resources.SettingsTxt, IsOpen, Electroplus_Media_Converter.Properties.Resources.OK, Electroplus_Media_Converter.Properties.Resources.Cancel,
        ...
        public void Validate()
        {
            if (port == 0)
            {
                throw new Exception(Electroplus_Media_Converter.Properties.Resources.InvalidPortName);
            }
            if (!isServer && string.IsNullOrEmpty(hostAddress))
            {
                throw new Exception(Electroplus_Media_Converter.Properties.Resources.InvalidHostName);
            }
        }
