...
namespace Gurux.Common
{
    ...
    public static class GXCommon
    {
        ...
        static public void CheckFramework()
        {
            ...
            using (RegistryKey subKey = Registry.LocalMachine.OpenSubKey(net35))
            {
                if (subKey != null && Convert.ToUInt32(subKey.GetValue("Install")) == 1)
                {
                    ...
                    {
                        throw new Exception(Electroplus_Media_Converter.Properties.Resources.NetFramework35SP1MustBeInstalledBeforeTheApplicationCanBeUsed);
                    }
                    return;
                }
            }
            throw new Exception(Electroplus_Media_Converter.Properties.Resources.NetFramework35SP1Or40MustBeInstalledBeforeTheApplicationCanBeUsed);
        }
        ...
        public static byte[] HexToBytes(string str, bool includeSpace)
        {
            ...
            if (str.Length % cnt != 0)
            {
                throw new ArgumentException(Electroplus_Media_Converter.Properties.Resources.NotHexString);
            }
